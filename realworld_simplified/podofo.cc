...
int main(int argc, char *argv[]) {
  ...
  memcpy(m_oValue, argv[0], 32); // Problem: if executable name is less than 32 bytes then memcpy will read out of bound because it does not respect string null terminator
}
