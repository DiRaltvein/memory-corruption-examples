// https://github.com/gpac/gpac/issues/3180
...
int main() {
  u8 sdt_data[] = {
      ...
      0x00, 0x00, // service id
      0x00,       // 6 reserved bits + EIT schedule flag  + EIT present/following flag
      0xF0,       // 3 bits running status + free CA mode flag + 4 bits descriptors loop length
      0x02,       // 8 additional bits of descriptors loop length
