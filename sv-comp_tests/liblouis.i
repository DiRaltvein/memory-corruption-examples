...
void lou_logFile(const char *fileName) {
 ...
 if (fileName == ((void*)0) || fileName[0] == 0) return;
 strcpy(initialLogFileName, fileName);
 logFile = fopen(fileName, "a");
 if (logFile == ((void*)0) && initialLogFileName[0] != 0)
...
void lou_logPrint(const char *format, ...) {
 ...
 if (logFile == ((void*)0)) logFile = fopen(initialLogFileName, "a");
 if (logFile == ((void*)0)) logFile = stderr;
...
void lou_logEnd(void) {
 if (logFile != ((void*)0) && logFile != stderr) fclose(logFile);
 logFile = ((void*)0);
}
int main() {
